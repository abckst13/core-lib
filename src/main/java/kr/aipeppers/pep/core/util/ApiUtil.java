...
import kr.aipeppers.pep.core.data.ModelBox;
...
public class ApiUtil {
	...
	public static void setThreadName(Box paramBox, String transacId, String clientSys, String empNo, String logId) {
		...
		String nUserId = threadBox.getString("userId");
		if(StringUtil.isNotEmpty(nUserId)) {
			sb.append("userId:").append(nUserId).append("|");
		}
