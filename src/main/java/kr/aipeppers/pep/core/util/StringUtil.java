...
public class StringUtil {
	...
	public static String nvl(String value, String defaultValue) {
		if(isEmpty(trim(value)) || "null".equals(value)) {
			return defaultValue;
		}
		return value;
	}
...
//			str = str.substring(0, size);
	...
	public static String getPwd(int len) {
		...
		for(int idx = 0; idx < len; idx++) {
			rtnPwd += String.valueOf((char)(rand.nextInt(26) + 65)) + String.valueOf((char)(rand.nextInt(26) + 97)) + String.valueOf(rand.nextInt(10));
		}
		return rtnPwd.substring(0, len);
	}
	...
	public static UUID getUUID(String str) {
		try {
			...
			throw new BizException("F118", new String[]{"UUID"});
		}
	}
