...
import kr.aipeppers.pep.core.mybatis.CamelMapObjectWrapperFactory;
//import kr.aipeppers.pep.core.mybatis.CustomSqlSessionTemplate;
import kr.aipeppers.pep.core.mybatis.ReloadMapper;
...
public class SpringDataSource {
	private static final String EXPRESSION = "execution(* kr.aipeppers.pep..*Service.*(..))";
...
//			SqlSessionFactoryBean factoryBean = new SqlSessionFactoryBean();
			...
			factoryBean.setMapperLocations(matchingResolver.getResources("kr/aipeppers/pep/**/mapper/*.xml")); //classpath:dbio/*.xml
