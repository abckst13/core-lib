 ...
 *
 */
public class ReloadMapper extends SqlSessionFactoryBean implements DisposableBean {
	private static final Log log = LogFactory.getLog(ReloadMapper.class);
