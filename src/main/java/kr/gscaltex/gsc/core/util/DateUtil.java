...
//	private static final String DEFAULT_FORMAT_PATTERN = DEFAULT_PARSE_PATTERN[8];
	private static final String DEFAULT_FORMAT_PATTERN = DATE_TIME_DC_PATTERN;
	...
	public static int getAge(String birthDay) {
		DateTime birthDate = parseToDateTime(birthDay, DateUtil.DATE_PATTERN);
		DateTime nowDate = new DateTime();
		Years year = Years.yearsBetween(birthDate, nowDate);
	 ...
	 * @return
	 */
	public static int getKorAge(String birthDay) {
		DateTime birthDate = parseToDateTime(birthDay, DateUtil.DATE_PATTERN);
		DateTime nowDate = new DateTime();
	 ...
	 * @return
	 */
	public static int getAgeBand(String birthDay) {
		return getAge(birthDay) / 10 * 10;
	}
	 ...
	 * @return
	 */
	public static int getKorAgeBand(String birthDay) {
		return getKorAge(birthDay) / 10 * 10;
	}

//	public static void main(String[] args) {
//		DateTime birthDate = parseToDateTime("20120101", DateUtil.DATE_PATTERN);
//		DateTime nowDate = new DateTime();
//		Years year = Years.yearsBetween(birthDate, nowDate);
//		int korAge = nowDate.getYear() - birthDate.getYear() + 1;
//		log.debug("age: " + year.getYears());
//		log.debug("korAge: " + korAge);
//		log.debug("ageBand: " + (year.getYears() / 10 * 10));
//		log.debug("korAgeBand: " + (korAge / 10 * 10) );

//		log.debug("age: " + getAge("20120101"));
//		log.debug("korAge: " + getKorAge("20120101"));
//		log.debug("ageBand: " + getAgeBand("20120101"));
//		log.debug("korAgeBand: " + getKorAgeBand("20120101"));
//	}
}
